...
raise 'MongoDB ingress must be limited to chat, backup, recovery, and bootstrap pods' unless ingress.fetch(0).dig('from', 0, 'podSelector', 'matchExpressions', 0, 'values').sort == %w[backup bootstrap chat recovery]
